...
@file: arguments.py
@date: 2021-07-01 14:46
@desc: Here are the param for the training
"""
...
def get_common_args():
    ...
    parser.add_argument('--alg', type=str, default='reinforce', help='the algorithm to train the agent')
...
def get_coma_args(args):
    ...
    # epsilon-greedy
    args.epsilon = 0.5
    args.anneal_epsilon = 0.00064  # 退火
